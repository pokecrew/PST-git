...
int chargerObjets(char mapPath[], FileDecors *fileDecors, FilePorte *filePorte, char Mat_Dialogue[100][150]);//fonction qui charge les  objets décors, portes, un à un dans leurs files
...
//Changement Map
int changeMap(int numMap, Case **Map, FileDecors *fileDecors, FilePorte *filePorte, SDL_Rect *perso_position, char Mat_Dialogue[100][150]);//fonction qui permet de changer de carte
